"""Retired Qt WebEngine window. Native widgets are the default launcher (`python -m desktop.main`).

Kept so existing Chromium probe tests can still import the old shell. Do not launch
this module as the product. See docs/native-python-migration.md unit 6.
"""
