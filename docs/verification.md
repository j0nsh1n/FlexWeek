...
| Native Qt widgets (no WebEngine) | `desktop/tests/test_native.py`, `test_server.py` native-mode case | Drag create/move/resize, Day/Month, undo, focus tools, recovery transfer, packaging smoke |
